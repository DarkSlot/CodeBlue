...
#include "AIShipMovementComponent.generated.h"

/**
 * 
 */
UCLASS(ClassGroup = Movement, meta = (BlueprintSpawnableComponent))
class UAIShipMovementComponent : public UPawnMovementComponent
{
	GENERATED_BODY()

		UAIShipMovementComponent();
...
public:
	...
	/** Angular acceleration (rate of angle change of velocity) */
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = FloatingPawnMovement)
