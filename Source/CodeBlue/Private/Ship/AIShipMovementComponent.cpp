...
UAIShipMovementComponent::UAIShipMovementComponent()
{
	MaxSpeed = 1200.f;
	Acceleration = 4000.f;
	Deceleration = 8000.f;
...
void UAIShipMovementComponent::TickComponent(float DeltaTime, enum ELevelTick TickType, FActorComponentTickFunction *ThisTickFunction)
{
...
bool UAIShipMovementComponent::LimitWorldBounds()
{
...
void UAIShipMovementComponent::ApplyControlInputToVelocity(float DeltaTime)
{
...
bool UAIShipMovementComponent::ResolvePenetrationImpl(const FVector& Adjustment, const FHitResult& Hit, const FQuat& NewRotationQuat)
{
